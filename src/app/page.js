          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="bg-indigo-50/50 rounded-2xl p-5 border-2 border-dashed border-indigo-100 space-y-3">
              ...
              <p className="text-[10px] text-slate-400 italic pt-1">
                * $1.5T target announced by public media sources. Indicative only.
              </p>
            </div>
            ...
            <p className="text-center text-[10px] text-slate-400 leading-relaxed">
              By submitting you agree this is an indication of interest only and does not constitute
